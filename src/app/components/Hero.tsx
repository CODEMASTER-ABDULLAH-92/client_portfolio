    ...
    <section className=" w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-snug sm:leading-tight md:leading-tight text-[#909090]">
          ...
          a <span className="text-white">Dropshipping & E-commerce Expert</span> with{" "}
          <span className="text-white">8+ years of experience</span> in{" "}
          <span className="text-white">Amazon, eBay & AliExpress</span> store management, 
          account handling, and <span className="text-white">virtual assistance</span> services.
          <Image
            alt="Sun"
            src={sun}
            className="inline-block ml-2 sm:ml-3 animate-spin-slow align-middle"
        ...
        {/* Awards Section - Updated for E-commerce */}
        <div className="flex flex-col sm:flex-row sm:flex-wrap justify-start items-start gap-4 mt-10 sm:mt-12 md:mt-14">
          {[
            "Top-Rated Virtual Assistant",
            "Amazon & eBay Specialist",
            "Dropshipping Expert",
          ].map((award, index) => (
            <div
              key={index}
        ...
        {/* Stats Section - Updated for E-commerce */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 sm:mt-16">
          {[
            { value: "8+", label: "Years in E-commerce" },
            { value: "500+", label: "Accounts Managed" },
            { value: "1000+", label: "Negative Feedback Removed" },
  ...
  {[
    {
      ...
      description: "Expert in product listing, inventory management, order fulfillment, and account health maintenance on Amazon."
    },
    {
