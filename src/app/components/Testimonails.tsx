...
const testimonials = [
  {
    ...
    name: "Khadija Siddiqui",
    message:
      "Our eBay store was suspended without warning. The team got it reinstated within 48 hours and helped us understand policy compliance. Amazing service!",
    img: "https://i.pravatar.cc/150?img=15",
    business: "eBay Seller",
  ...
  },
  {
    ...
    name: "Danish Mehmood",
    message:
      "I was struggling with product sourcing and low margins. Their consulting team helped me find reliable suppliers and increased my profit margins by 40%.",
    img: "https://i.pravatar.cc/150?img=16",
    business: "Dropshipping Store Owner",
    issue: "Product Sourcing"
  },
  {
    id: 17,
    name: "Noor Fatima",
    message:
      "My listings weren't getting any visibility. After their optimization strategy, my sales tripled in just 30 days. They truly understand eBay's algorithm.",
    img: "https://i.pravatar.cc/150?img=17",
    business: "eBay Power Seller",
    issue: "Listing Optimization"
  },
  {
    id: 18,
    name: "Ali Hassan",
    message:
      "Their inventory management system saved me from overselling during Q4. I went from daily stress to fully automated order fulfillment. Absolute game-changer!",
    img: "https://i.pravatar.cc/150?img=18",
  ...
  },
  {
    ...
    name: "Fatima Khan",
    message:
      "The customer service training they provided transformed our business. Now we have happy customers and 90% positive feedback rating on our store.",
    img: "https://i.pravatar.cc/150?img=19",
...
const testimonials1 = [
  {
    ...
    name: "Bilal Sheikh",
    message:
      "I had no idea how to price my products competitively. Their market analysis strategy helped me find the sweet spot and I'm now seeing 200% ROI.",
    img: "https://i.pravatar.cc/150?img=8",
    business: "eBay Entrepreneur",
    issue: "Sales Strategy"
  },
  {
    id: 9,
    name: "Mariam Javed",
    message:
      "My order fulfillment was a nightmare. They set up automated systems and now I process 100+ orders daily with zero errors. I can finally sleep peacefully!",
    img: "https://i.pravatar.cc/150?img=9",
    business: "Dropshipping Specialist",
  ...
  },
  {
    ...
    name: "Omar Farooq",
    message:
      "The team helped me scale from 50 products to 500 in just 3 months. Their product research and listing strategies are unmatched in the industry.",
    img: "https://i.pravatar.cc/150?img=10",
    business: "eBay Store Owner",
    issue: "Store Scaling"
  },
  {
    id: 11,
    name: "Hira Malik",
    message:
      "I was about to give up on dropshipping due to policy violations. They fixed all my listings, educated me on compliance, and saved my business.",
    img: "https://i.pravatar.cc/150?img=11",
    business: "Dropshipping Newbie",
  ...
  },
  {
    ...
    name: "Zain Raza",
    message:
      "Their account management service is like having a full-time eBay expert on your team. My account health score went from average to top-rated seller.",
    img: "https://i.pravatar.cc/150?img=12",
    business: "Top-Rated eBay Seller",
  ...
  },
  {
    ...
    name: "Laiba Khan",
    message:
      "I was struggling with supplier reliability. They connected me with vetted suppliers and I've never had a single issue since. Quality products, on time delivery.",
    img: "https://i.pravatar.cc/150?img=13",
    business: "Home & Garden Store",
    issue: "Supplier Relations"
  },
  {
    id: 14,
    name: "Ahmed Rauf",
    message:
      "The conversion optimization strategy they implemented doubled my sales. My product images, descriptions, and pricing are now perfectly optimized.",
    img: "https://i.pravatar.cc/150?img=14",
    business: "Fashion Brand",
    issue: "Conversion Optimization"
  },
  {
    id: 20,
    name: "Hassan Qureshi",
    message:
      "I was losing money on advertising. Their team showed me how to target the right audience and now my ad spend has 5x ROI. Worth every penny!",
    img: "https://i.pravatar.cc/150?img=20",
    business: "eBay Marketer",
...
const test3 = [
  {
    ...
    name: "Abdullah",
    message:
      "Our eBay store went from $5k to $25k monthly revenue in just 60 days. Their strategic approach to listing optimization and product sourcing is incredible.",
    img: "https://i.pravatar.cc/150?img=1",
    business: "eBay Power Seller",
  ...
  },
  {
    ...
    name: "Ali Khan",
    message:
      "The dropshipping blueprint they provided was a game-changer. I went from zero knowledge to running a profitable store in just 30 days. Highly recommend!",
    img: "https://i.pravatar.cc/150?img=2",
    business: "New Dropshipper",
    issue: "Store Setup"
  },
  {
    id: 3,
    name: "Sara Ahmed",
    message:
      "My Shopify store was getting traffic but no sales. They optimized my product pages and checkout process, resulting in a 150% increase in conversions.",
    img: "https://i.pravatar.cc/150?img=3",
    business: "Shopify Entrepreneur",
    issue: "Conversion Optimization"
  },
  {
    id: 4,
    name: "Hamza Tariq",
    message:
      "Their eBay listing optimization service is the best in the industry. My items are now ranking on the first page and I'm getting consistent daily sales.",
    img: "https://i.pravatar.cc/150?img=4",
    business: "eBay Super Seller",
    issue: "SEO & Ranking"
  },
  {
    id: 5,
    name: "Ayesha Noor",
    message:
      "I had 20 different suppliers and was overwhelmed. They consolidated my sourcing and now I have 3 reliable suppliers with better prices and faster shipping.",
    img: "https://i.pravatar.cc/150?img=5",
    business: "Multi-Store Owner",
    issue: "Supplier Management"
  },
  {
    id: 6,
    name: "Fatima Zahra",
    message:
      "The customer service protocols they implemented reduced my refunds by 70%. My customers are happier and my store reputation has never been better.",
    img: "https://i.pravatar.cc/150?img=6",
    business: "eBay Store Manager",
  ...
  },
  {
    ...
    name: "Usman Ali",
    message:
      "I was spending 12 hours a day managing my store. Their automation solutions freed up 70% of my time, and I'm now seeing 3x the revenue with half the effort.",
    img: "https://i.pravatar.cc/150?img=7",
    business: "Full-Time Dropshipper",
  ...
  return (
    <div id="success-stories" className="w-full max-w-7xl mx-auto px-4 py-12 md:py-16 lg:py-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 md:mb-14">
        <div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight">
            Dropshipping Success <span className="text-[#ea8b61]">Stories</span>
          </h2>
          <p className="text-[#909090] mt-3 text-sm md:text-base max-w-xl">
            Real results from dropshippers and eBay sellers who transformed their businesses
          </p>
        </div>
        ...
        {/* Decorative elements */}
        <div className="hidden md:flex items-center gap-2">
          <svg className="w-5 h-5 text-[#ea8b61]" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          </svg>
            ...
            {[...testimonials, ...testimonials].map((item, index) => (
              ...
              >
                <div className="flex items-start gap-2 mb-3">
                  <span className="text-[#ea8b61] text-sm font-semibold uppercase tracking-wider bg-[#ea8b61]/10 px-2 py-1 rounded">
                    {item.issue}
                  </span>
                </div>
                ...
                <div className="mt-4 flex justify-start items-center gap-3">
                  ...
                  <div>
                    <span className="text-white font-medium block text-sm">{item.name}</span>
                    <span className="text-[#909090] text-xs">{item.business}</span>
                  </div>
                </div>
              </div>
            ))}
